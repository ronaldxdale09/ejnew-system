...
$query = "SELECT * FROM coffee_sale_line WHERE coffee_sale_id = '$sales_id'";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $productDropdown = '<select class="form-select" name="u_product[]" style="width: 100px;">';
    $productDropdown .= '<option>Select...</option>';

    // Inner query to fetch coffee names
    $coffeeSql = "SELECT coffee_name FROM coffee_products";
    ...
    if ($coffeeResult) {
        while ($coffeeRow = mysqli_fetch_assoc($coffeeResult)) {
            ...
            $productDropdown .= "<option value='" . $coffeeRow['coffee_name'] . "' $selected>" . $coffeeRow['coffee_name'] . "</option>";
        }
    }
    ...
    $(document).ready(function() {
        ...
        $("#addProductUpdate").click(function() {
            ...
            var newRow = `
                ...
                <td>
                    <div class="input-group mb-3">
                        <select class="form-select" name="u_product[]" style="width: 100px;">
