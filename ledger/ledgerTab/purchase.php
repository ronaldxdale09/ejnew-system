    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-sm">
              <button type="button" class="btn btn-success text-white" data-toggle="modal" data-target="#purchase-modal"> ADD PURCHASE </button>
              <button type="button" class="btn btn-cyan text-white" data-toggle="modal" data-target="#modal"> NEW CATEGORY </button>
            </div>
            <div class="col-sm">
              <div class="row">
                <div class="col"></div>
