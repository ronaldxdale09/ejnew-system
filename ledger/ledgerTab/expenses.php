    ...
    <div class="col">
        <div class="stat-card">
            <div class="stat-card__content">
                <p class="text-uppercase mb-1 text-muted">EXPENSES TODAY (<?php echo date("F d"); ?>)</p>
...
<div class="row" style="display: flex; align-items: center;">
    ...
    <div class="col-sm-4">
        <div class="btn-group">
            ...
            <button type="button" class="btn btn-primary text-white" data-toggle="modal" data-target="#addPlantExpense">
                <i class="fa fa-plus" aria-hidden="true"></i> MALOONG EXPENSE
            </button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-danger btn-sm  text-white btnExpenseDelete"
...
$('#addPlantExpense').on('shown.bs.modal', function() {
    $('.ex_category', this).chosen();
});
