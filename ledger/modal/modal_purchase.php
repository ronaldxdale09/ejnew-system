            ...
            <form action="function/ledger/addPurchase.php" id='submitPurchase' method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label for="p_net-kilos">Net Weight</label>
                    ...
                    <!-- <div class="form-group">
                        <div class="row no-gutters">
                            ...
                            <div class="col">
                                <label style='font-size:15px' class="col-md-12">Gross Amount :</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">₱</span>
                                    </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col">
                            <label style='font-size:15px' class="col-md-12">Less: Total Discount</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">₱</span>
                                </div>
                        ...
                        <div class="col">
                            <label style='font-size:15px;' class="col-md-12">Less: Partial Payment
                            </label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">₱</span>
                    ...
                    <div class="row no-gutters">
                        <div class="col">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" style='text-align:right' name='p_total_amount' id='p_total_amount'
