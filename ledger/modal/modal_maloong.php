                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" style='text-align:right' name='ejn_price'
                                                            id='ejn_price' onkeypress="return CheckNumeric()"
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" style='text-align:right' name='topper_price'
                                                            id='topper_price' onkeypress="return CheckNumeric()"
                                                            onkeyup="FormatCurrency(this)" class="form-control"
                                                            autocomplete='off'>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group mb-5">
                                                        ...
                                                        <input type="text" style='text-align:right' name='topper_total'
                                                            id='topper_total' class="form-control"
