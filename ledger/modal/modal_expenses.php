    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
          <form action="../function/ledger/updateExpenses.php" method="POST">
            <input type="text" id="my_id" name="my_id" style="display : none;"> <!--hide from uder, for db locate id only -->
            <div class="container-fluid">
                <div class="row">
                  <div class="col-md-12">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="col-md-12">DATE</label>
                          <div class="col-md-12">
                            <input class='datepicker'  type="date" id="update_date" name="update_date" required>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="col-md-12">VOUCHER #</label>
                          <div class="col-md-8">
                            <input type="text" name='update_voucher' id="update_voucher" class="form-control form-control-line" required>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="col-md-12">PARTICULARS</label>
                          <div class="col-md-12">
                            <input type="text" name='update_particular' id="update_particular_name" class="form-control form-control-line" required>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="col-md-12">Category</label>
                          <div class="col-md-12">
                            <input class="form-control" list="datalistOptions" name='update_category' id="update_category" placeholder="Search Category">
                            <datalist id="datalistOptions"> <?php echo $exCatList; ?> </datalist>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="row no-gutters">
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="input-group mb-5">
                                ...
                                <input type="text" style='text-align:right' name='update_amount' id="update_amount" class="form-control" onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)" required>
                              </div>
                            </div>
                          </div>
                        </div>
