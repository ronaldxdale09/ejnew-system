                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <input type="text" name='voucher' class="form-control form-control-line"
                          placeholder="Enter Voucher #" required>
                      </div>
                    </div>
                  </div>
                </div>
                <br>
                <!-- CATEGORY AND MODE OF TRANSACTION !-->
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="col-md-12">MODE OF TRANSACTION</label>
                      <div class="col-md-12">
                        <select name="modeTransact" class="form-control form-control-line" required>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <input type="text" name='particulars' class="form-control form-control-line"
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <input type="text" name='remarks' class="form-control form-control-line"
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="col-md-12">Category</label>
                      <div class="col-md-12">
                        <input class="form-control" list="datalistOptions" name='update_category' id="update_category"
                      ...
                      <div class="row no-gutters">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="input-group mb-5">
                            ...
                            <input type="text" style='text-align:right' name='update_amount' id="update_amount"
