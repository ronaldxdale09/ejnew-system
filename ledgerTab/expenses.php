                        ...
                        <div class="card">
                            <div class="card-body">
                               <!-- CONTENT -->
                                ...
                                <div class="row">
                        <div class="col-sm">
                        <button type="button" class="btn btn-success text-white" data-bs-toggle="modal" data-bs-target="#addExpense">
                               ADD EXPENSE
                                </button>
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <?php while ($row = mysqli_fetch_array($results)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                <button type="button" class="btn btn-success text-white"><span class="fa fa-shopping-cart"></span></button> 
