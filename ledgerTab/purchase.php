                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                               <!-- CONTENT -->
                                ...
                                <div class="row">
                        <div class="col-sm">
                        <button type="button" class="btn btn-success text-white" data-bs-toggle="modal" data-bs-target="#purchase-modal">
                                ADD PURCHASE
                                </button>
                                <button type="button" class="btn btn-cyan text-white" data-bs-toggle="modal" data-bs-target="#modal">
                                NEW CATEGORY
                                </button>
                        </div>
                        <div class="col-sm">
                        <div class="row">
                              ...
                              <h5> Date Filter </h5>
                              <div class="col"><b></b><input type="text" id="p_min" name="p_min"  class="form-control" placeholder="From Date" /> </div>
                              <div class="col"><input type="text" id="p_max" name="p_max"  class="form-control" placeholder="To Date" />  </div>
                           </div>
                        </div>
                     </div>
                     <br>
                                ...
                                <div class="table-responsive ">
                                    ...
                                    <?php while ($row = mysqli_fetch_array($results)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                <button type="button" class="btn btn-success text-white"><span class="fa fa-edit"></span></button> 
