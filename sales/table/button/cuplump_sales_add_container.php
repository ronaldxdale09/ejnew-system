...
if ($check->num_rows == 1) {
    ...
    $sql = "INSERT INTO sales_cuplump_selected_container (container_id,cuplump_sales_id, van_no,total_weight,total_cuplump_cost,ship_expense,ave_cost) 
    VALUES ('$container_id','$sales_id','$van_no', '$total_weight',  '$total_cost',  '$ship_exp', '$ave_cost')";
    $results = mysqli_query($con, $sql);
}
