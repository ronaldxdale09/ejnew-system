...
$check = mysqli_query($con, "SELECT * FROM bales_shipment_container WHERE container_id='$container_id' AND shipment_id='$shipment_id'");
$arrCheck = mysqli_fetch_array($check);

if ($check->num_rows == 1) {
    $sql = "UPDATE bales_shipment_container 
    SET van_no='$van_no',
    ...
    $sql = "INSERT INTO bales_shipment_container (container_id,shipment_id, van_no, bale_quality, kilo_bale,num_bales,total_weight, remarks) 
