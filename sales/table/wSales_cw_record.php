...
$cost_per_kilo = 0.0;
$output .= '  
<table class="table table-bordered table-hover table-striped" id="recording_table-receiving" style="font-size: 13px !important" >
           <thead class="table-dark" style="font-size: 13px !important" >
               <tr >
