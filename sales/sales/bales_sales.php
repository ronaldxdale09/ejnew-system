                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" readonly class="form-control" name='bale_kilo_cost'
                                    id='bale_kilo_cost' style="width: 100px;" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name='ship_exp_zmfreight'
                                    id='ship_exp_zmfreight' style="width: 100px;" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name='ship_exp_mtrucking'
                                    id='ship_exp_mtrucking' style="width: 100px;" />
                            </div>
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name='total_ship_exp' id='total_ship_exp'
                                    readonly style="width: 100px;" />
                            </div>
                        </div>
                    </div>
