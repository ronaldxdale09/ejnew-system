...
$ave_kilo_cost_basilan  = !empty($data['total_weight']) ? ($data['total_bale_cost'] / $data['total_weight']) : 0;
$ave_kilo_cost_basilan_wMill  = !empty($data['total_weight']) ? (($data['total_bale_cost'] + $data['overall_milling_cost']) / $data['total_weight']) : 0;
    ...
    <div class="col-md-3 col-6 mb-2">
        <div class="stat-card">
            <div class="stat-card__content">
                ...
                <h5><?php echo number_format($bales_basilan['inventory'] ?? 0, 0); ?> kg</h5>
            </div>
    ...
    <div class="col-md-3 col-6 mb-2">
        <div class="stat-card">
            <div class="stat-card__content">
                ...
                <h5><?php echo number_format($balesCount_basilan['inventory'] ?? 0, 0); ?> pcs</h5>
            </div>
    ...
    <div class="col-md-3 col-6 mb-2">
        <div class="stat-card">
            <div class="stat-card__content">
                ...
                <h5>₱ <?php echo number_format($ave_kilo_cost_basilan ?? 0, 2); ?></h5>
            </div>
    ...
    <div class="col-md-3 col-6 mb-2">
        <div class="stat-card">
            <div class="stat-card__content">
                ...
                <h5>₱ <?php echo number_format($ave_kilo_cost_basilan_wMill ?? 0, 2); ?></h5>
            </div>
...
<div class="sales-toolbar">
    <button type="button" class="sales-btn sales-btn--primary" data-bs-toggle="modal" data-bs-target="#purchaseModal">
        <i class="fas fa-plus"></i> New Outside Purchase
    </button>
</div>

<div class="table-responsive">
    <table class="table table-hover table-striped w-100 bale-inventory-dt" style="width:100%"
        id="recording_table-produced-basilan" data-location="Basilan">
