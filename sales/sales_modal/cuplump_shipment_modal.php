        ...
        <div class="modal-content">
            ...
            <form action="function/cuplump_shipment.php" method="POST">
                <div id="print_content">
                    <div class="modal-body">
                        <input type="text" class="form-control" id='v_ship_id' name='ship_id' hidden autocomplete='off'
                            style="width: 100px;" />
                        <div class="row">
                            <div class="col">
                                <label style='font-size:15px' class="col-md-12">Type</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id='v_type' readonly autocomplete='off'
                                        style="width: 100px;" />
                                </div>
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label style='font-size:15px' class="col-md-12">Source</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id='v_source' autocomplete='off' readonly
                                        style="width: 100px;" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id='v_vessel' readonly autocomplete='off'
                                        style="width: 100px;" />
                                </div>
                            </div>
                            <div class="col">
                                <label style='font-size:15px' class="col-md-12">Bill of
                                    Lading</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" namid='v_info_lading' readonly
                                        autocomplete='off' style="width: 100px;" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <label style='font-size:15px' class="col-md-12">Remarks</label>
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id='v_remarks' readonly autocomplete='off'
                                        style="width: 100px;" />
                                </div>
                            </div>
                            <div class="col">
