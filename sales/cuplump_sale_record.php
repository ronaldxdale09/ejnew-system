...
sales_shell_open('Cuplump Sale', 'Cuplump sales contracts and payments');
...
<?php sales_render_filters([
    'buyerSql' => "SELECT DISTINCT buyer_name AS val FROM sales_cuplump_record WHERE buyer_name IS NOT NULL AND buyer_name != ''",
]); ?>
...
<script src="js/sales-cuplump-sales-record.js"></script>
