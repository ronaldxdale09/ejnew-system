                                    ...
                                    <tbody>
                                        <?php while ($row = mysqli_fetch_array($results)) { ?>
                                            <tr>
                                                ...
                                                <td> <span class="badge bg-secondary"><?php echo $row['recording_id'] ?> </span></td>
                                                ...
                                                <td class="number-cell">₱
                                                    <?php
                                                    // Check if net_weight is not zero before performing division
                                                    if ($row['net_weight'] != 0) {
                                                        echo number_format(($row['total_amount'] / $row['net_weight']), 2, '.', ',');
                                                    } else {
                                                        echo "N/A"; // if net_weight is zero, display "N/A" or any default value of your choice
                                                    }
                                                    ?>
                                                </td>
                                                <td>Basilan</td>
