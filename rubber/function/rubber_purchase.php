<?php 
 ...
 include('db.php');
                            ...
                            $net_weight = str_replace( ',', '', $_POST['m_net']);
                             ...
                             //UPDATE CONTRACT
                             if ($contract !='SPOT'){
                                $getContract = mysqli_query($con, "SELECT  * from wet_rubber_contract WHERE contract_no = '$contract'  ");
                                ...
                                $sql=mysqli_query($con,"UPDATE `wet_rubber_contract` SET `delivered` = '$newDelivered' , balance='$newBalance',status='$status' WHERE `contract_no` ='$contract'");
                                echo $balance;
                            }
                            ...
                            $query = "INSERT INTO wet_rubber_transaction (
