                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label class="col-md-12">Seller</label>
                                <div class="col-md-12">
                                    <input type="text" style='text-align:center' name='name' id='m_name'
                                        class="form-control" style='background-color:white;border:0px solid #ffffff;'
                                        readonly>
                                </div>
                            </div>
                        ...
                        <div class="row no-gutters">
                            <div class="col-12 col-sm-5 col-md-12">
                                ...
                                <div class="input-group mb-1">
                                    ...
                                    <input type="text" style='text-align:right,font-size:16' name='price' id='m_price'
                                        class="form-control" onkeypress="return CheckNumeric()"
                    ...
                    <center>
                        <div class="col-6 col-md-12">
                            <div class="input-group mb-12">
                                ...
                                <input type="text" style='text-align:left' name='d_id' id='d_id' class="form-control"
                                    hidden readonly />
