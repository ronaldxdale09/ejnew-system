...
<div class="ops-inv-panel">
    <div class="ops-inv-panel__head">Bale Inventory Details — Basilan</div>
    <div class="ops-inv-panel__body p-0">
        <div class="table-responsive">
            <table class="table table-hover table-striped w-100 mb-0" id="basilan_inventory_table">
                <thead>
                    <tr>
                        <th>Status</th>
                        <th>Bale ID</th>
...
<script>
window.__baleInvBasilan = <?php echo json_encode([
