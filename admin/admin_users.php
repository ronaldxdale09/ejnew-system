                        ...
                        <div class="tab-pane fade show active rounded bg-white" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select" name='location' style='width:200px' required>
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-select" name='user_type' style='width:200px' required>
                                                                    <option disabled="disabled" selected="selected" value="">
                                                                        Select
                                                                        Type
                                                                    </option>
                            ...
                            <div class="container bg-white rounded p-3 mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <br>
                                    <button class="btn text-light mt-2" style="background: #067bbe;" data-toggle="modal" data-target="#exampleModalCenter"><b><i class='bx bx-user-plus'></i> Add
                                            Account</b></button>
                                </div>
                                <br>
                                <table class="table table-hover" id="user_table"><?php
                                    ...
                                    <tbody>
                                        <?php while ($rowU = mysqli_fetch_array($results_users)) { ?>
                                            <tr data-bs-toggle="modal" data-bs-target="#openActionModal" data-bs-user_type="<?php echo $rowU['type'] ?>" data-bs-user_password="<?php echo $rowU['password'] ?>" data-bs-id="<?php echo $rowU['id'] ?>" data-bs-username="<?php echo $rowU['username'] ?>" data-bs-loc="<?php echo $rowU['loc'] ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input class="form-control" style="text-transform: capitalize" name='update_user_type' id="update_user_type" placeholder="User type" readonly>
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input class="form-control" style="text-transform: capitalize" id="update_loc" name='update_loc' readonly>
                                                ...
                                                <div class="col">
                                                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                                                        <div class="card card-body">
                                                            <p>Please confirm to remove this account. This account will remove
                            ...
                            <script>
                                ...
                                exampleModalRemove.addEventListener('show.bs.modal', event => {
                                    ...
                                    const loc = exampleModalRemove.querySelector('.modal-body #update_loc')
