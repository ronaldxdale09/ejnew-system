...
<div class="main-content admin-page">
    <?php adm_page_header('Basilan Expense Report', 'Monthly expense breakdown by type — all amounts in Philippine Peso (₱).', ['Basilan']); ?>
    <?php include "statistical_card/expense.card.php"; ?>
    <?php adm_panel_open('Monthly Expense by Type'); ?>
