                                    ...
                                    <div class="table-responsive">
                                        ...
                                        GROUP BY planta_recording.recording_id"); ?>
                                            ...
                                            <tbody> <?php while ($row = mysqli_fetch_array($results)) { ?> <tr>
                                                        ...
                                                        <td class="number-cell">
                                                            <?php echo $row['reweight'] !== null ? number_format($row['reweight'], 0, '.', ',') : '0'; ?> kg
                                                        </td>
                                                        <td class="number-cell" hidden>
                                                            <?php echo $row['crumbed_weight'] !== null ? number_format($row['crumbed_weight'], 0, '.', ',') : '0'; ?>
                                                            kg</td>
                                                        <td class="number-cell" hidden>
                                                            <?php echo $row['dry_weight'] !== null ? number_format($row['dry_weight'], 0, '.', ',') : '0'; ?> kg
                                                        </td>
                                                        <td class="number-cell">
                                                            <?php echo $row['produce_total_weight'] !== null ? number_format($row['produce_total_weight'], 0, '.', ',') : '0'; ?> kg
                                                        </td>
                                                        <td class="number-cell">
                                                            <?php echo $row['drc'] !== null ? number_format($row['drc'], 2, '.', ',') : '0'; ?> %
                                                        </td>
                                                        <td class="number-cell">₱
                                                            <?php echo $row['production_expense'] !== null ? number_format($row['production_expense'], 0, '.', ',') : '0'; ?>
                                                        </td>
                                                        <td class="number-cell">₱
                                                            <?php echo $row['milling_cost'] !== null ? number_format($row['milling_cost'], 2, '.', ',') : '0'; ?>
                                                        </td>
