                            ...
                            <tbody style="width:100%;font-size: 14px;">
                                ...
                                <tr>
                                    ...
                                    <td style='font-weight:bold;background-color: rgb(210, 252, 225)'>
                                        <?php echo empty($row['total']) || $row['total'] == 0 ? "-" : "" . number_format((float)$row['total'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['JAN']) || $row['JAN'] == 0 ? "-" : "" . number_format((float)$row['JAN'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['FEB']) || $row['FEB'] == 0 ? "-" : "" . number_format((float)$row['FEB'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['MAR']) || $row['MAR'] == 0 ? "-" : "" . number_format((float)$row['MAR'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['APR']) || $row['APR'] == 0 ? "-" : "" . number_format((float)$row['APR'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['MAY']) || $row['MAY'] == 0 ? "-" : "" . number_format((float)$row['MAY'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['JUNE']) || $row['JUNE'] == 0 ? "-" : "" . number_format((float)$row['JUNE'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['JULY']) || $row['JULY'] == 0 ? "-" : "" . number_format((float)$row['JULY'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['AUG']) || $row['AUG'] == 0 ? "-" : "" . number_format((float)$row['AUG'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['SEP']) || $row['SEP'] == 0 ? "-" : "" . number_format((float)$row['SEP'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['OCT']) || $row['OCT'] == 0 ? "-" : "" . number_format((float)$row['OCT'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['NOV']) || $row['NOV'] == 0 ? "-" : "" . number_format((float)$row['NOV'], 0, '.', ','); ?>
                                    </td>
                                    <td><?php echo empty($row['DECE']) || $row['DECE'] == 0 ? "-" : "" . number_format((float)$row['DECE'], 0, '.', ','); ?>
                                    </td>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="top">
                                ...
                                <table class="table table-hover" id='expenses_report'>
                                    <thead class='table-dark'>
                                        <tr>
                                            <th>Year</th>
                                            <th> <select class='form-select' name='month' id="expenses_filter_month"
                                                    onchange="ExpensesfilterMonth()">
                                                    <option value=""
                                                        <?php if ($ExpensesMonth == '') echo 'selected'; ?>>All</option>
                                                    <option value="1"
                                                        <?php if ($ExpensesMonth == 1) echo 'selected'; ?>>January
                                                    </option>
                                                    <option value="2"
                                                        <?php if ($ExpensesMonth == 2) echo 'selected'; ?>>February
                                                    </option>
                                                    <option value="3"
                                                        <?php if ($ExpensesMonth == 3) echo 'selected'; ?>>March
                                                    </option>
                                                    <option value="4"
                                                        <?php if ($ExpensesMonth == 4) echo 'selected'; ?>>April
                                                    </option>
                                                    <option value="5"
                                                        <?php if ($ExpensesMonth == 5) echo 'selected'; ?>>May</option>
                                                    <option value="6"
                                                        <?php if ($ExpensesMonth == 6) echo 'selected'; ?>>June</option>
                                                    <option value="7"
                                                        <?php if ($ExpensesMonth == 7) echo 'selected'; ?>>July</option>
                                                    <option value="8"
                                                        <?php if ($ExpensesMonth == 8) echo 'selected'; ?>>August
                                                    </option>
                                                    <option value="9"
                                                        <?php if ($ExpensesMonth == 9) echo 'selected'; ?>>September
                                                    </option>
                                                    <option value="10"
                                                        <?php if ($ExpensesMonth == 10) echo 'selected'; ?>>October
                                                    </option>
                                                    <option value="11"
                                                        <?php if ($ExpensesMonth == 11) echo 'selected'; ?>>November
                                                    </option>
                                                    <option value="12"
                                                        <?php if ($ExpensesMonth == 12) echo 'selected'; ?>>December
                                                    </option>
                                                </select></th>
                        ...
                        <div class="col-sm-4">
                            <Br>
                            <canvas id="expense_bar_chart" style="width: 100%; height: 300px"></canvas>
                        </div>
                    </div>
