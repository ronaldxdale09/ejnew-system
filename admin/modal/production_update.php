    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <h5 class="modal-title"> Production Record</h5>
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" readonly class="form-control gray-background" id="production_id"  name="production_id"  readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="amount" class="form-label">Production Date</label>
                                        <input type="date" readonly class="form-control" name="prod_date" id='prod_date' aria-describedby="amount" required>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="amount" class="form-label">Production Code</label>
                                        <input type="text"readonly  class="form-control gray-background" id="production_code" name="production_code"  aria-describedby="amount" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="amount" class="form-label">Recorded By</label>
                                        <input type="text" readonly class="form-control" name="recorded_by"  id="recorded_by" >
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" readonly class="form-control" id="no_sack" name="no_sack" onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)" required>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" readonly  class="form-control" id="u_entry_weight" name="entry_weight" onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)" required>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" readonly class="form-control gray-background" id="u_global_total_weight" name="production_totalWeight" readonly aria-describedby="amount" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-2">
