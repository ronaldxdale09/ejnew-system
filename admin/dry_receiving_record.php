                        ...
                        <div class="container-fluid shadow p-3 mb-5 bg-white rounded">
                            ...
                            $(document).ready(function() {
                                ...
                                $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
                                    ...
                                    // Location filter
                                    if (locationFilter !== '') {
                                        var address = data[4].toLowerCase();
                                        var source = data[9].toLowerCase();
                                        var searchTerm = locationFilter.toLowerCase();
                                        
                                        if (!address.includes(searchTerm) && !source.includes(searchTerm)) {
                                            showRow = false;
                                        }
                                    }
                                    ...
                                    if (statusFilter !== '') {
                                        ...
                                        var statusTerm = statusFilter.toLowerCase();
                                        
                                        if (!status.includes(statusTerm)) {
                                            showRow = false;
                                        }
                                    }
...
<div class="modal fade" id="createNew" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog  ">
        <div class="modal-content">
            ...
            <form method='POST' action='../../rubber/function/newDryReceiving.php'>
