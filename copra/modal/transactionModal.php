        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col">
                                <div class="input-group mb-1">
                                    ...
                                    <label style='font-size:15px' class="col-md-12">Withholding tax :</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Tax</span>
                                        </div>
                                        <input type="text" class="form-control" id='m_tax' name='m_tax' readonly
                                            onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)" />
                    ...
                    <input name="m_tax-amount" id="m_tax-amount" hidden>
                            ...
                            <div class="input-group mb-1">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" id='approved_by' name='approved_by'
                                        value='RICHARD B. NEW' onkeypress="return CheckNumeric()"
                                        onkeyup="FormatCurrency(this)" />
                                </div>
...
$(document).ready(function() {
    $('#print_voucher').click(function() {
        ...
        const nw = window.open("voucher/print_voucher.php", "_blank", "height=1403,width=850");
...
$(document).ready(function() {
    $('#print_receipt').click(function() {
        var nw = window.open("voucher/print_receipt.php", "_blank", "height=1344,width=816");
