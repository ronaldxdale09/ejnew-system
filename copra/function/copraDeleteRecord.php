<?php 
 include('db.php');
                        if (isset($_POST['remove'])) {
                            ...
                            $query = mysqli_query($con, "SELECT * from `copra_transaction` WHERE id='$id'"); 
                            ...
                            if($row['less'] != 0){
                                ...
                                $query = "UPDATE  copra_seller SET cash_advance = '$cash_advance_return' where name='$seller'  ";
                            ...
                            if ($contract !== "SPOT") {
                                ...
                                $query = "DELETE FROM `copra_transaction`  WHERE id='$id';";
                                $results = mysqli_query($con, $query);
