(function ($) {
    ...
    window.CopraDt = {
        ...
        ajaxError: function (xhr) {
            ...
            console.error('Copra DataTable error:', msg, xhr);
        },
        ...
        filterParams: function (opts) {
            ...
            return function () {
                ...
                if (opts.startDate) {
                    out.startDate = CopraDt.parseFilterDate(opts.startDate);
                }
                if (opts.endDate) {
                    out.endDate = CopraDt.parseFilterDate(opts.endDate);
                }
                return out;
            };
        },
        ...
        initServerTable: function (selector, options) {
            ...
            var ajaxOpts = CopraDt.ajax(options.url, function (d) {
