                ...
                <div class="tab-pane fade show active rounded bg-white" id="pills-home" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select" name='location' style='width:200px'
                                                            required>
                    ...
                    <div class="container bg-white rounded p-3 mb-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <br>
                            <button class="btn text-light mt-2" style="background: #067bbe;" data-toggle="modal"
                                data-target="#exampleModalCenter"><b><i class='bx bx-user-plus'></i> Add
                                    Account</b></button>
                        </div>
                        <br>
                                ...
                                <div class="modal-body">
                                    <form action="./function/admin/update_user.php" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input class="form-control"
                                                            style="text-transform: capitalize" name='update_user_type'
                                                            id="update_user_type" placeholder="User type" readonly>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input class="form-control" 
                                                            ...
                                                            id="update_loc" name='update_loc' readonly>
                                        ...
                                        <button type="submit" name="submit" class="btn btn-success"><i
                                                class='bx bx-check'></i> Save Changes</button>
                                    </form>
                                    <br>
                                    <hr>
                                    <button type="button" data-toggle="collapse" href="#multiCollapseExample1"
                                        role="button" aria-expanded="false" aria-controls="multiCollapseExample1"
                                        class="btn btn-danger"><i class='bx bx-trash'></i> Remove Account</button>
