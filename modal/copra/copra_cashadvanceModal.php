...
<div class="modal fade" id="editCA" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit CA</h5>
                <button type="button" class="btn" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="function/copra/newCA.php" method="POST">
                    <!-- ... START -->
                    <input type="text" style='text-align:right' name='id' id='m_id'readonly hidden>
                    <div class="form-group">
                        <div class="row no-gutters">
                            <div class="col-6 col-md-6">
                                <div class="input-group mb-1">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default"
                                            style='color:black;font-weight: bold;'>Seller ID</span>
                                    </div>
                                    <input type="text" style='text-align:right' name='code' id='m_code'
                            ...
                            <div class="col-6 col-md-6">
                                <div class="input-group mb-1">
                                    <input type="text" id="m_name" name='name'   class="form-control"  readonly>
                                </div>
                            </div>
                            <!--  end-->
                        </div>
                        ...
                        <div class="row no-gutters">
                            <div class="col-12 col-sm-5 col-md-12">
                                ...
                                <div class="input-group mb-1">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default"
                                            style='color:black;font-weight: bold;'>Current CA</span>
                                    </div>
                                    <input type="text" style='text-align:right' id='m_cashadv'  class="form-control" readonly>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" name='update_ca' class="btn btn-success text-white">Update</button>
                </form>
            </div>
        </div>
    </div>
