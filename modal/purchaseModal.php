<!-- Modal -->
<div class="modal" id="purchase-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <form action="function/ledger/addPurchase.php" id='submitPurchase' method="POST">
        <div class="modal-body">
              ...
              <div class="col-6 col-md-6">
                <div class="input-group mb-1">
                  <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroup-sizing-default" style='color:black;font-weight: bold;'>Voucher</span>
                  </div>
                  <input type="text" style='text-align:right' name='p_voucher' id='p_voucher' class="form-control" style='background-color:white;border:0px solid #ffffff;'>
                </div>
              </div>
              <!--end  -->
              <div class="col-6 col-md-6">
                <select class='pur_category' name='pur_category' id='pur_category' style='width:200px' required>
                  <option disabled="disabled" selected="selected">Select Category</option> <?php echo $purCatList; ?>
                </select>
              </div>
            </div>
            <br>
          ...
          <div class="form-group">
            ...
            <div class="col-md-8">
              <input type="text" name='p_name' id='p_name' class="form-control form-control-line" required>
            </div>
          </div>
          <!-- net kilos -->
          <br>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-12 col-sm-5 col-md-7">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" style='text-align:right' name='p_price' id='p_price' onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)" class="form-control">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row no-gutters">
              <div class="col-12 col-sm-5 col-md-6">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control" id='p_adjustprice' name='p_adjustprice' onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)" />
                </div>
                <!--  -->
              </div>
              <div class="col-6 col-md-6">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-12 col-sm-5 col-md-7">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" style='text-align:right' name='p_partial_payment' id='p_partial_payment' onkeypress="return CheckNumeric()" onkeyup="FormatCurrency(this)" class="form-control">
                </div>
              </div>
            </div>
          </div>
