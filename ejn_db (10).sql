...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2022 at 05:30 AM
...
INSERT INTO `bales_transaction` (`id`, `invoice`, `date`, `address`, `contract`, `seller`, `delivery_date`, `lot_code`, `entry`, `net_weight_1`, `net_weight_2`, `total_net_weight`, `kilo_bales_1`, `kilo_bales_2`, `total_bales_1`, `total_bales_2`, `bales_compute`, `drc`, `price_1`, `price_2`, `first_total`, `second_total`, `total_amount`, `less`, `amount_paid`, `words_amount`) VALUES
(6, '002', '2022-09-23', 'Titay', 'SPOT', 'Mark Tubat', '2022-09-23', 'E', 8777, 788, 0, 788, 35, 0, '22 Bales & 18 Kg', '0 Bales ', NULL, 9, 78, 0, NULL, NULL, 61464, 30000, 31464, 'Thirty One Thousand Four Hundred Sixty Four peso/s'),
(8, '004', '2022-10-01', 'Titay', '2022-003', 'Mark Tubat', '2022-10-01', 'E', 23335, 20000, 2000, 22000, 35, 33, '571 Bales & 15 Kg', '60 Bales ', NULL, 94, 54, 0, NULL, NULL, 1080000, 30000, 1050000, 'One Million Fifty Thousand Peso/s '),
(10, '004', '2022-10-01', 'Titay', 'SPOT', 'Mark Tubat', '2022-10-01', '677', 34444, 344, 0, 344, 35, 1, '9 Bales & 29 Kg', '0 Bales ', '9.29', 1, 344, 0, NULL, NULL, 118336, 30000, 88336, 'Eighty Eight Thousand Three Hundred Thirty Six Peso/s '),
(11, '004', '2022-10-08', 'Titay', 'SPOT', 'Mark Tubat', '2022-10-08', '677', 50000, 10000, 0, 10000, 35, 1, '285 Bales & 25 Kg', '0 Bales ', '285.25', 20, 50, 0, NULL, NULL, 500000, 0, 500000, 'Five Hundred Thousand Peso/s ');
...
(24, '2022-005', 'dale ronald', 1000, NULL, 0, 'PENDING', '2022-09-23', 25);
...
(12, 'dale ronald', '1000', 'ntc', '2022-10-09', 'PENDING');
...
CREATE TABLE `planta_recording` (
  ...
  `actual_kilo` int(11) DEFAULT NULL,
...
INSERT INTO `planta_recording` (`recording_id`, `date`, `seller`, `address`, `driver`, `truck_number`, `actual_kilo`, `reweight`, `cost`, `total_amount`, `status`) VALUES
(1, '2022-10-07', 'Ronald Dale', 'San Jose Cawa Cawa', 'Ronald ', 'AS3W', 2333, 233, 2333, 4, 'FIELD');

--
-- Triggers `planta_recording`
--
DELIMITER $$
CREATE TRIGGER `recording_logs` AFTER UPDATE ON `planta_recording` FOR EACH ROW INSERT into planta_recording_logs VALUES (null,NEW.recording_id,NEW.date,NEW.seller,NEW.address,NEW.driver,NEW.truck_number,NEW.actual_kilo,NEW.reweight,NEW.cost,NEW.total_amount,NEW.status)
$$
DELIMITER ;
...
CREATE TABLE `planta_recording_logs` (
  ...
  `actual_kilo` int(11) NOT NULL,
  `reweight` int(11) NOT NULL,
...
INSERT INTO `planta_seller` (`id`, `name`, `address`, `contact`) VALUES
(2, 'Ronald Dale', 'Lamitan', '09352232051');
...
(4, '2022-003', 'Mark Tubat', 1000, 0, 1000, '2022-09-15', 29, 'UPDATED', 'BALES'),
...
(1, 'Mark Tubat', 'Titay', '09352232051', 30000, 30000);
...
(8, 2, 'SPOT', '2022-09-30', 'Mark Tubat', 'Titay', 5000, 2000, 3000, 1000, 0, 3000, 0, 3000000, 0, 3000000, '', 'WET'),
(9, 3, 'SPOT', '2022-10-01', 'Mark Tubat', 'Titay', 5666, 54, 5612, 45, 0, 5612, 0, 252540, 0, 252540, 'Two Hundred Fifty Two Thousand Five Hundred Forty Peso/s ', 'WET');
...
--
-- Indexes for table `planta_seller`
--
ALTER TABLE `planta_seller`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `planta_recording`
  MODIFY `recording_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `planta_seller`
--
ALTER TABLE `planta_seller`
