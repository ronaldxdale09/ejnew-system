...
<div class="modal fade" id="modal_mil_record" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Cancel</button>
                <button type="submit" name="milling_field_trans" class="btn btn-dark text-light">Return to Field</button>
...
<script>
document.querySelector('button[name="milling_field_trans"]').addEventListener('click', function(e) {
    e.preventDefault(); // Prevent the default submit behavior

    Swal.fire({
        title: 'Are you sure?',
        text: "Do you want to transfer the record back to Field?",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            ...
            var form = document.querySelector('#modal_mil_record form');
            form.querySelector('#action').value = 'milling_field';
            // Submit the form
            form.submit();
        }
    });
