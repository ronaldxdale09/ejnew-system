                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col">
                                    <div class="input-group mb-12">
                                        ...
                                        <div class="col-md-12">
                                            <input readonly type="text" class='form-control' id="purchasing_date" name="purchasing_date">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col">
                                    <div class="input-group mb-12">
                                        ...
                                        <div class="col-md-12">
                                            <input readonly type="text" class='form-control' id="receiving_date" name="receiving_date">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="input-group mb-12">
                                        ...
                                        <input readonly type="text" style='text-align:right' name='reweight' id='reweight'
                                            class="form-control" >
                                        <div class="input-group-append">
                                            <span class="input-group-text">Kg</span>
                                        </div>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col">
                                    <div class="input-group mb-12">
                                        ...
                                        <div class="col-md-12">
                                            <input readonly type="text" class='form-control' id="milling_date" name="milling_date">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-5">
                            ...
                            <div class="col-3">
                                <div class="input-group mb-12">
                                    ...
                                    <input readonly type="text" style='text-align:right' name='bale_excess' id='bale_excess'
